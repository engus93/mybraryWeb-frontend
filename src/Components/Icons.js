...
export const DropHamburger = ({ className, size = 24, fill = "white" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    width={size}
...
export const Home = ({ className, size = 24, fill = "white" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    width={size}
...
export const GitHub = ({ className, size = 24, fill = "white" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    width={size}
...
export const Write = ({ className, size = 24, fill = "white" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    width={size}
...
export const Nothing = ({ className, size = 24, fill = "black" }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    width={size}
...
export const DotMenu = ({ className, size = 24, fill = "black", onClick }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    width={size}
...
export const Exit = ({ className, size = 24, fill = "white", onClick }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    width={size}
...
export const FloatingWrite = ({ className }) => (
...
export const PostBookCover = ({ className, onClick, size }) => (
  // eslint-disable-next-line jsx-a11y/alt-text
  <img
    style={{ cursor: "pointer", width: `${size}px`, height: `${size}px` }}
    className={className}
    onClick={onClick}
    src="data:image/svg+xml;utf8;base64,"
  />
);
